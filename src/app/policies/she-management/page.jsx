          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <p>
                ...
                is IKHGROUPS Policy to comply with the requirements of the
                Health & Safety at work. Equally, it is recognized that
                employees have a duty of care to themselves and others by
                avoiding hazards, preventing accidents and co-operating with the
                Company by complying with all instructions and recommendations
                on health and safety if the aims and objectives of this policy
                are to be achieved.
              </p>

              <h3>Health & Safety Policy</h3>
              <p>
                IKHGROUPS pays every importance to good health, safety
                performance at all areas of operations to achieve business
                objectives. Management is committed to take an integrated
                approach where managing health and safety forms as a part of the
                overall business strategy, protection of human resources,
                properties, environment and the same commitment will be
                demonstrated by all levels of supervision in the organization.
                Vigorous efforts will extend prevention of accident in all
                possible ways and implications. We consider the same as an
                important element in our construction process and are the direct
                responsibility of our Projects Management Team. IKHGROUPS
                assures that projects will be carried out with high degree of
                safety to attain this objective. Our projects management will
                strive to provide a safe and healthy environment that is free
                from recognized potential hazards and will maintain its
                facilities and equipment at maximum safe operating standards.
              </p>
              ...
              <ul className="list-style-template">
                ...
                <li>
                  To train and inform all employees about occupational health
                  and safety issues.
                </li>
              </ul>
              ...
              <p>
                ...
                the best environmental practices however and whenever
                practicable. Each operating business unit is committed to meet
              ...
              <ul className="list-style-template">
                ...
                <li>
                  To ensure effective use of nonrenewable natural resources and
                  to help recovery and re-use.
                </li>
