          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p>
                ...
                are managed in accordance with quality plans tailored to meet
                our client's specific requirements. In order to ensure
                compliance with our Quality Management System, regular quality
                audits are carried out throughout the organization.
              </p>

              <h3>Quality Policy</h3>
              <p>
                IKHGROUPS is in the field of Electro Mechanical contracting
              ...
              <p>
                ...
                establishing quality objectives in line with quality policy and
                to review them on continual basis.
              </p>
              ...
              <p>
                ...
                improving system and reducing the possibility of
                non-conformance.
              </p>

              <p>
                IKHGROUPS is working to implement the quality assurance system
                as part of its policies and is working on its ISO9001:2008
              ...
              <p>
                ...
                specifications and quality standards defined by the customer
                (via his/her representative). To this end, every operating unit
                is required:
              </p>

              <ul className="list-style-template">
                <li>
                  To maintain staff able to interpret, clarify and conform to
