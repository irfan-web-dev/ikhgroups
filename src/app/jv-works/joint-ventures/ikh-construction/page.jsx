          ...
          >
            ...
            >
              <div className="jv-text-content">
                ...
                {/* PDF Section: IKH General Construction Company Profile */}
                <div
                  style={{
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      alignItems: "center",
                      background:
                        "linear-gradient(90deg,rgb(210, 108, 25) 0%,rgb(243, 187, 33) 100%)",
                      border: "none",
                      color: "#fff",
                      fontWeight: "bold",
                      fontSize: "1.15rem",
                    ...
                    aria-controls="ikh-pdf-viewer"
                  >
                    IKH BD Trading Profile
                    <span
                      style={{
                        marginLeft: "8px",
                        fontSize: "1.2em",
                  ...
                  {showPdf && (
                    ...
                    >
                      ...
                      {/* The PDF iframe */}
                      <iframe
                        src="/documents/IKH_BD_Trading.pdf"
                        title="IKH General Construction Profile"
                        width="100%"
                        height="100%"
                        style={{
                          border: "none",
