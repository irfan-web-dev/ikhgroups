  ...
  return (
    <>
      <section className="hero-section-template">
        ...
        >
          <source src="/videos/overhead-lines-bg.mp4" type="video/mp4" />
          ...
          <div className="content-box-template animate-on-scroll slide-up visible">
            ...
            <div className="service-section">
              ...
              <p>
                ...
                We employ specialized teams trained in safety protocols for both
                power and communication line work.
              </p>
            </div>
            ...
            <div className="service-section">
              ...
              <p>
                ...
                equipment to handle projects of any scale across Saudi Arabia's
                diverse landscapes.
              </p>
            </div>
          </div>
