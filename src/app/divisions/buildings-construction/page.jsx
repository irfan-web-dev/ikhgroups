  ...
  return (
    <>
      <section className="hero-section-template">
        ...
        >
          <source src="/videos/building-construction.MP4" type="video/mp4" />
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p>
                ...
                works, MEP installations, and finishing works. We employ
                advanced project management systems to ensure timely completion
                while maintaining the highest standards of safety and quality.
                Our team of architects, engineers, and construction
                professionals work collaboratively to transform architectural
                visions into reality, paying meticulous attention to every
                detail from foundation to rooftop.
              </p>
              <p>
