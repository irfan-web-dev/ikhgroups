        ...
        <div className="content-container-template">
          ...
          <div className="content-box-template animate-on-scroll slide-up visible">
            ...
            <div className="service-section">
              ...
              <p>
                ERP is business management software that allows an organization
                to use a system of integrated applications to manage the
                business. ERP software contains many modules that an enterprise
                would require, based on what best meets its specific needs and
            ...
            <div className="service-section">
              ...
              <p>
                ...
                of interest. We provide various other services that suites your
                need at affordable prices, quality and satisfaction guaranteed.
              </p>
            </div>
