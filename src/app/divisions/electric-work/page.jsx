  ...
  return (
    <>
      <section className="hero-section-template">
        ...
        >
          <source src="/videos/electric-work.mp4" type="video/mp4" />
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p>
                ...
                installations, lighting systems, power distribution networks,
                and renewable energy integrations. We specialize in high-voltage
                electrical systems for industrial applications, including
                substations, transformers, and switchgear installations. All our
                work complies with Saudi Electricity Company (SEC) regulations
                and international electrical codes.
              </p>
              <p>
                For commercial projects, we implement energy-efficient lighting
                solutions, emergency power systems, and smart building
                automation. Our residential services cover everything from basic
                wiring to complete home automation systems. We use only
                premium-grade materials from trusted manufacturers to ensure
                long-term reliability and performance of all our electrical
                installations.
              </p>
              <p>
                Our team stays updated with the latest electrical technologies
                including solar power integration, EV charging stations, and
                energy management systems. We provide 24/7 emergency services
                for critical electrical systems, with rapid response teams
                available across major cities in Saudi Arabia. From design to
                implementation and maintenance, we offer comprehensive
                electrical solutions tailored to each client's specific
                requirements.
              </p>
            </div>
          </div>
